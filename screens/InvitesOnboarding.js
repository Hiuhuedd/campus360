...
const Slide = ({item}) => {
  return (
    <View style={{alignItems: 'center'}}>
      <Image
        source={item?.image}
        style={{height: '65%', width:width-40, resizeMode: 'contain'}}
      />
      <View>
...
const InvitesOnboarding = ({navigation}) => {
  ...
  return (
    <SafeAreaView style={{flex: 1,display:"flex",flexDirection:"column",alignItems:"center",width}}>
 <LinearAtom   pv={5}  ph={20} bg={COLORS.white} br={0} mv={0} mh={0} w="100%"  el={0} sh='#000' colors={[COLORS.black,COLORS.dark]} >
