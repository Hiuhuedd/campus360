...
const BottomSheet = React.forwardRef(({onMethodSelected,navigation,nearestclinic,photoUrl,state}, ref) => {
  ...
  return (
    <RBSheet
      ...
      >
          <View style={styles.bottomCard}>
                ...
                <Text style={styles.text_}><Feather name="map-pin" size={SIZES.icon}     color={COLORS.primary}/> {Math.round(state.distance)} km away </Text>
   ...
   />
       ...
       <Button text={"Proceed"}width={250}bg={COLORS.primary} navigation={navigation} borderRadius={5} screen="Home"  onMethodSelected={onMethodSelected}/>
                    </View>
            </View>
    </RBSheet>
  );
